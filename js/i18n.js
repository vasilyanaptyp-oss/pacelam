...
const D = {
  lv: {
    ...
    take: 'Ņemu', take_for: 'Ņemu par {p} €', bid_hint_urgent: 'Steidzami: pasūtītājs izvēlas no piedāvājumiem uzreiz, tiklīdz tie pienāk. Zemāka cena — lielākas izredzes.', agree_hint: 'Tu piekrīti pasūtītāja cenai. Viņš izvēlēsies piedāvājumu — un kontakti atvērsies uzreiz.', agree_sent: 'Piedāvājums nosūtīts. Pasūtītājs izvēlas.', bid: 'Sava cena', bid_send: 'Nosūtīt cenu', bid_amount: 'Cena, €', bid_note: 'Piezīme (nav obligāta)', bid_placed: 'Cena nosūtīta.', bid_withdraw: 'Atsaukt', bid_update: 'Mainīt cenu',
  ...
  ru: {
    ...
    take: 'Беру', take_for: 'Беру за {p} €', bid_hint_urgent: 'Срочно: заказчик выбирает из предложений сразу, как только они приходят. Меньшая цена — больше шансов.', agree_hint: 'Ты соглашаешься на цену заказчика. Он выберет предложение — и контакты откроются сразу.', agree_sent: 'Предложение отправлено. Заказчик выбирает.', bid: 'Своя ставка', bid_send: 'Отправить ставку', bid_amount: 'Ставка, €', bid_note: 'Примечание (не обязательно)', bid_placed: 'Ставка отправлена.', bid_withdraw: 'Отозвать', bid_update: 'Изменить ставку',
    ...
    col_kind: 'Вид', col_route: 'Маршрут', col_detour: 'Крюк', col_distance: 'Расстояние', col_date: 'Дата', col_vehicle: 'Транспорт', col_cargo: 'Груз', col_weight: 'Вес · габариты', col_price: 'Цена · ставки', col_age: 'Выложено',
