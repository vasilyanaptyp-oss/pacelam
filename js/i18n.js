...
const D = {
  lv: {
    ...
    deals_n: 'darījumi: {n}', deals_new: 'darījumu vēl nav', member_since: 'Paceļam kopš {d}', signup_to_publish: 'Lai saņemtu piedāvājumus, izveido bezmaksas kontu — tas ir vienreiz. Pieteikums saglabāts.', guest_last_step: 'Pēdējais solis: bezmaksas konts, lai pārvadātāji varētu atsūtīt cenu. Viss aizpildītais saglabāsies.', pending_post: 'Pieteikums vēl nav publicēts',
    pairs_trucks: 'Transports pa ceļam', pairs_cargo: 'Kravas pa ceļam', pairs_none_trucks: 'Pagaidām šajā virzienā transporta nav. Kad parādīsies — saņemsi paziņojumu.', pairs_none_cargo: 'Pagaidām kravu pa ceļam nav. Kad parādīsies — saņemsi paziņojumu.', nudge: 'Pasaukt', nudged: 'Pasaukts ✓', nudge_ok: 'Pārvadātājam nosūtīts atgādinājums.', n_truck: 'Pa jūsu maršrutu brauc transports: {from} → {to}', n_nudge: 'Pasūtītājs aicina: krava {from} → {to} pa ceļam',
    km_unit: 'km', m_detour: 'līkums', m_detour_none: 'bez līkuma', m_route: 'pamatmaršruts', m_from_you: 'no tevis', m_trip: 'kravas ceļš', m_trip_truck: 'maršruts',
    dim_l: 'Garums', dim_w: 'Platums', dim_h: 'Augstums', wiz_for_truck: 'Šī transporta pārvadātājs uzreiz saņems paziņojumu un atsūtīs savu cenu.',
    wiz_urgent: 'Steidzami — šodien', wiz_urgent_sel: 'Šodien, steidzami', wiz_wait_q: 'Cik ilgi varat gaidīt?', wiz_wait_hint: 'Uz kartītes ies atpakaļskaitīšana — pārvadātāji redzēs, cik laika atlicis.', wait_label: 'Gaida', wait_left: 'gaida vēl {t}', wait_over: 'gaidīšana beigusies', min_short: 'min', h_short: 'h',
    ...
    kind_cargo: 'Krava', kind_truck: 'Transports', mode_urgent: 'Steidzami', mode_planned: 'Nesteidzami',
    ...
    // 23.09.2026, evening edits of the client and the audit: names instead of codes, "from where" the distance counts, demo bar
    wiz_vehicle_add: 'Pievienot citu transportu', posted_by_you: 'Tas ir tavs sludinājums', pairs_for_you: 'tavam transportam', tag_mine: 'Mans',
    m_to_pickup: 'līdz iekraušanai', m_loaded: 'ar kravu', here_k: 'Attālumu rēķinu no', here_set: 'Norādi savu pilsētu', here_title: 'Kur tu esi?',
  ...
  ru: {
    ...
    wiz_what_cargo: 'Что везём?', wiz_what_truck: 'Какая машина?', wiz_more: 'Ещё: нужный транспорт, примечание', wiz_more_truck: 'Ещё: свободное место, примечание', wiz_vehicle_once: 'Машина заводится один раз — в следующий раз она уже выбрана.', wiz_vehicle_save: 'Сохранить машину', wiz_truck_price_hint: 'Цену называет только перевозчик. Не укажешь — на карточке будет «договоримся».', price_word: 'Цена', negotiable: 'договоримся',
    ...
    deals_n: 'сделок: {n}', deals_new: 'сделок пока нет', member_since: 'на Paceļam с {d}', signup_to_publish: 'Чтобы получить предложения, создайте бесплатный аккаунт — это один раз. Заявка сохранена.', guest_last_step: 'Последний шаг — бесплатный аккаунт, чтобы перевозчики могли прислать цену. Всё заполненное сохранится.', pending_post: 'Заявка ещё не опубликована',
    pairs_trucks: 'Машины по пути', pairs_cargo: 'Грузы по пути', pairs_none_trucks: 'Пока нет машин по этому пути. Как только появится — придёт уведомление.', pairs_none_cargo: 'Пока нет грузов по пути. Как только появится — придёт уведомление.', nudge: 'Позвать', nudged: 'Позвали ✓', nudge_ok: 'Перевозчику отправлено напоминание.', n_truck: 'По вашему маршруту едет машина: {from} → {to}', n_nudge: 'Заказчик зовёт вас: груз {from} → {to} по пути',
    km_unit: 'км', m_detour: 'крюк', m_detour_none: 'без крюка', m_route: 'твой маршрут', m_from_you: 'от тебя', m_trip: 'путь груза', m_trip_truck: 'маршрут',
    dim_l: 'Длина', dim_w: 'Ширина', dim_h: 'Высота', wiz_for_truck: 'Перевозчик этой машины сразу получит уведомление и пришлёт свою цену.',
    wiz_urgent: 'Срочно — сегодня', wiz_urgent_sel: 'Сегодня, срочно', wiz_wait_q: 'Сколько можете ждать?', wiz_wait_hint: 'На карточке пойдёт обратный отсчёт — перевозчики увидят, сколько осталось.', wait_label: 'Ждёт', wait_left: 'ждёт ещё {t}', wait_over: 'ожидание закончилось', min_short: 'мин', h_short: 'ч',
    ...
    kind_cargo: 'Груз', kind_truck: 'Транспорт', mode_urgent: 'Срочно', mode_planned: 'Не срочно',
    ...
    take: 'Беру', take_for: 'Беру за {p} €', bid_hint_urgent: 'Срочно: заказчик увидит твою цену сразу и может согласиться немедленно.', agree_hint: 'Ты соглашаешься на цену заказчика. Он выберет предложение — и контакты откроются сразу.', agree_sent: 'Предложение отправлено. Заказчик выбирает.', bid: 'Предложить цену', bid_send: 'Отправить цену', bid_amount: 'Моя цена, €', bid_note: 'Примечание (не обязательно)', bid_placed: 'Цена отправлена. Заказчик увидит её в списке.', bid_withdraw: 'Отозвать', bid_update: 'Изменить цену',
    ...
    deal_pending_you: 'Твоё предложение приняли. Подтверди сделку — откроются контакты.', deal_pending_other: 'Ждём подтверждения второй стороны.',
    ...
    close_posting: 'Закрыть объявление', close_confirm: 'Закрыть объявление? Предложения будут отклонены.', closed_ok: 'Объявление закрыто.',
    ...
    // 23.09.2026, evening edits of the client and the audit: names instead of codes, where distances count from, demo bar
    wiz_vehicle_add: 'Добавить другую машину', posted_by_you: 'Это твоё объявление', pairs_for_you: 'для твоей машины', tag_mine: 'Моё',
    m_to_pickup: 'до погрузки', m_loaded: 'с грузом', here_k: 'Расстояние считаю от', here_set: 'Укажи свой город', here_title: 'Где ты сейчас?',
  ...
  en: {
    ...
    deals_n: 'deals: {n}', deals_new: 'no deals yet', member_since: 'on Paceļam since {d}', signup_to_publish: 'To get offers, create a free account — once. Your posting is saved.', guest_last_step: 'Last step: a free account, so carriers can send you a price. Everything you filled in is kept.', pending_post: 'Posting not published yet',
    pairs_trucks: 'Vehicles on the way', pairs_cargo: 'Cargo on the way', pairs_none_trucks: 'No vehicles this way yet. You will be notified when one appears.', pairs_none_cargo: 'No cargo on the way yet. You will be notified when some appears.', nudge: 'Call him', nudged: 'Called ✓', nudge_ok: 'The carrier got a reminder.', n_truck: 'A vehicle is going your way: {from} → {to}', n_nudge: 'A customer calls you: cargo {from} → {to} on your way',
    km_unit: 'km', m_detour: 'detour', m_detour_none: 'no detour', m_route: 'your route', m_from_you: 'from you', m_trip: 'cargo trip', m_trip_truck: 'route',
    dim_l: 'Length', dim_w: 'Width', dim_h: 'Height', wiz_for_truck: 'The carrier of this vehicle is notified at once and will send a price.',
    wiz_urgent: 'Urgent — today', wiz_urgent_sel: 'Today, urgent', wiz_wait_q: 'How long can you wait?', wiz_wait_hint: 'The card counts down — carriers see how much time is left.', wait_label: 'Waits', wait_left: 'waits {t} more', wait_over: 'waiting time is over', min_short: 'min', h_short: 'h',
    ...
    kind_cargo: 'Cargo', kind_truck: 'Transport', mode_urgent: 'Urgent', mode_planned: 'Not urgent',
    ...
    // 23.09.2026, evening edits of the client and the audit: names instead of codes, where distances count from, demo bar
    wiz_vehicle_add: 'Add another vehicle', posted_by_you: 'This is your posting', pairs_for_you: 'for your vehicle', tag_mine: 'Mine',
    m_to_pickup: 'to pickup', m_loaded: 'with cargo', here_k: 'Distances from', here_set: 'Set your town', here_title: 'Where are you?',
