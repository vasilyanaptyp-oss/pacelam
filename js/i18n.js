...
const D = {
  ...
  ru: {
    ...
    deals_n: 'сделок на Paceļam: {n}', deals_new: 'новый на Paceļam', member_since: 'на Paceļam с {d}', signup_to_publish: 'Чтобы получить предложения, создайте бесплатный аккаунт — это один раз. Заявка сохранена.', guest_last_step: 'Последний шаг — бесплатный аккаунт, чтобы перевозчики могли прислать цену. Всё заполненное сохранится.', pending_post: 'Заявка ещё не опубликована',
  ...
  en: {
    ...
    deals_n: 'deals on Paceļam: {n}', deals_new: 'new on Paceļam', member_since: 'on Paceļam since {d}', signup_to_publish: 'To get offers, create a free account — once. Your posting is saved.', guest_last_step: 'Last step: a free account, so carriers can send you a price. Everything you filled in is kept.', pending_post: 'Posting not published yet',
