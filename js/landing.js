...
(function () {
  ...
  const D = {
    ru: {
      ...
      lead: 'Перевозчик едет обратно пустым, заказчику надо отправить груз — <b>Paceļam</b> сводит обоих.',
    ...
    en: {
      ...
      lead: 'A carrier drives back empty, a customer needs cargo sent — <b>Paceļam</b> brings them together.',
