...
(function () {
  ...
  const D = {
    ru: {
      ...
      s1_h: 'Заявка', s1_p: 'Перевозчик предлагает транспорт или заказчик выкладывает груз — и выбирает режим: срочно или планово.',
      s2_h: 'Совпадения', s2_p: 'Биржа находит тех, кому это по пути, и шлёт уведомление.',
      s3_h: 'Цена', s3_p: 'Перевозчик соглашается с ценой заказчика или предлагает свою. Заказчик тоже может предложить цену перевозчику, который едет по пути.',
    ...
    en: {
      ...
      s1_h: 'Posting', s1_p: 'A carrier offers transport or a customer posts cargo — and picks a mode: urgent or planned.',
      s2_h: 'Matches', s2_p: 'The exchange finds carriers who have it on their way and notifies them.',
      s3_h: 'Price', s3_p: 'The carrier agrees to the customer\'s price or offers their own. The customer can also offer a price to a carrier who is driving that way.',
